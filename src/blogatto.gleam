...
/// ## Build steps
/// 
/// 1. Clean output directory and copy static assets. This is a prerequisite for all builders to ensure a fresh build environment and that static files are available for the pages and posts.
